...
import { Image, Dropdown, DropdownItem, DropdownTrigger, DropdownMenu } from "@heroui/react"
    ...
    >
      <DropdownTrigger aria-label="dropdown trigger">
        <div className="flex items-center gap-2 cursor-pointer min-w-fit">
          <Image alt="moeys-logo" className="flex-shrink-0" width={22} src={Icons.khmerFlagIcon} />
          <Typography variant="body2" className="font-semibold">ភាសាខ្មែរ</Typography>
          <div>
            {dropdown
              ? <ChevronUp className="-ml-1.5 text-[#034EA1]" />
      ...
      <DropdownMenu aria-label="dropdown menu">
        <DropdownItem
          ...
          startContent={<Image width={22} alt="moeys-logo" src={Icons.khmerFlagIcon} />}
          onPress={() => {}}
        />
        <DropdownItem
          key="khmer"
